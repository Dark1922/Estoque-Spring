package br.com.estoque.core.security;
...
import br.com.estoque.domain.service.impl.UserDetailsServiceImpl;
...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
				 ...
				 */
				.antMatchers("/index", "/usuarios/**").permitAll()
		...
		http.csrf().disable()
				...
				// filtrar demais requisições para verificar a presenção do token jwt no headerr
				// http
